...
class Interval2Screen:
    def __init__(self):
        ...
        self.animal_foot = pygame.transform.scale(
            pygame.image.load('assets/objects/Animal Footstep.png').convert_alpha(),
            (60, 60))
    ...
    def run(self):
        ...
        while running:
            ...
            if abs((player_position[0] + 36) - self.foot_positions[0]) < 70:
